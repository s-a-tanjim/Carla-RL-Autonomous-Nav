# glob.glob('/opt/carla-simulator/PythonAPI/carla/dist/carla-*%d.%d-%s.egg'
...
class CarEnv:
    ...
    def process_img(self, image):
        ...
        if self.SHOW_CAM:
            ...
            cv2.imwrite("Feedback.jpg", i3)
            # img = cv2.imread("Feedback.jpg", 0)
            # cv2.imshow("Feedback", i3)
            cv2.waitKey(10)
...
class DQNAgent:
    ...
    def create_model(self):
        ...
        predictions = Dense(3, activation="linear")(x) # 3 Action
