...
class CarlaCar:
  ...
  def __init__(self):
    ...
    spectator_transform = carla.Transform(self.vehicle.get_transform().transform(carla.Location(x=-4,z=2.5)),self.vehicle.get_transform().rotation) 
  ...
  def reset_simplified(self):
    ...
    # Move the spectator behind the vehicle to view it
    spectator = self.world.get_spectator() 
    spectator_transform = carla.Transform(self.vehicle.get_transform().transform(carla.Location(x=-8,z=2.5)),self.vehicle.get_transform().rotation) 
    spectator.set_transform(spectator_transform)
